...
<form name="login" action="StockBuddy_sellStockCalculation.jsp?username=<%=username%>&firstname=<%=firstname%>&lastname=<%=lastname%>" method="post" >  
    <table>
       <tr>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <input type="submit" value="Click here to Sell...!! " > 
</form>  
		<hr color="blue">
		<h4><font color="Red"><b>Are you sure you wanted to sell this stock?Click buy again to confirm it</b></font></h4>
