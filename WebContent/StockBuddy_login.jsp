...
<form name="login" action="StockBuddy_logincheck.jsp" method="post" >  
    <table>
       ...
       <td width="500"><input type="text" name="username" id="username" placeholder="username" required></td>
       </tr>
	  
	   <tr>
       <td width="100"><label for="password"><b>Password :</b></label>&nbsp;</td>
       <td width="500"><input type="password" name="password" id="password" placeholder="password" required></td>
	   </tr>
    </table>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <input type="submit" value="Login" onclick="return validate();"> <a href="StockBuddy_newAccount.jsp"><font color="Blue">NewUser</font></a>  
</form>  
		<hr color="blue">
