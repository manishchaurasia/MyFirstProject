...
if(stockname==""){
 alert("Enter the Stockname, you wanted to buy!!");
  return false;
} 
if(quantity==""){
...
<form name="login" action="StockBuddy_buyStockConfirm.jsp?username=<%=username%>&firstname=<%=firstname%>&lastname=<%=lastname%>" method="post" >  
    <table>
       <tr>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <input type="submit" value="Click here to buy...!! " onclick="return validate();"> 
</form>  
		<hr color="blue">
